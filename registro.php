...
<div class="bgimg-1 w3-display-container w3-opacity-min" id="inicio">
  <div class="w3-display-middle" style="white-space:nowrap;">
    <span class="w3-center w3-padding-large w3-black w3-xlarge w3-wide w3-animate-opacity"> REGISTRO<span class="w3-hide-small"> </span> </span>
  </div>
</div>
<br>
<form action="trabfinal.html">
  <div class="container">
    ...
    <div class="col-md-6">
    <input type="password" placeholder="Insira novamente sua senha" name="psw-repeat" required><?php
